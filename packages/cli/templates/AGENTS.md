...
| ---------------------------------------- | ----------------------------------- |
| `GET /api/v2/proposals?status=active`    | Proposals currently open for voting |
| `GET /api/v2/proposals?status=succeeded` | Proposals ready for execution       |
| `GET /api/v2/proposals?status=executed`  | Already executed proposals          |
| `GET /api/v2/proposals?status=defeated`  | Failed proposals                    |
| `GET /api/v2/agents`                     | All registered agents               |
